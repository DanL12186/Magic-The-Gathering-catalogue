...
* Minimum compatible Ruby version 2.4 (use of `.sum` and `.match?`); tested on Ruby 2.4.1 - 2.7.0 on Rails 5.2 - 6.0.3 on MacOS 10.9 - 10.14 and Win 7/10.
...
```ruby
  ...
  #populates Editions table. required to use Generate Booster Packs feature. 
  #You must require './db/seeds.rb' in console for this to be available
  create_all_editions
